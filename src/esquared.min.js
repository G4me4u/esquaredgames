...
var COLOR_RED=new ESColor(255,0,0),COLOR_GREEN=new ESColor(0,255,0),COLOR_BLUE=new ESColor(0,0,255),COLOR_YELLOW=new ESColor(255,255,0),COLOR_CYAN=new ESColor(0,255,255),COLOR_MAGENTA=new ESColor(255,0,255),COLOR_BLACK=new ESColor(0,0,0),COLOR_WHITE=new ESColor(255,255,255);var ESScreen=function(a,b,c){this.canvas=a;this.ctx=a.getContext("2d");this.width=b;this.height=c;this.pixels=Array.makeArray(b*c,COLOR_BLACK)};ESScreen.prototype.setPixel=function(a,b,c){0>a||a>=this.width||0>b||b>=this.height||(this.pixels[a+b*this.width]=c?c:COLOR_BLACK)};ESScreen.prototype.getPixel=function(a,b){return 0>a||a>=this.width||0>b||b>=this.height?null:this.pixels[a+b*this.width]};
ESScreen.prototype.drawToScreen=function(){var a=Math.min(Math.floor(this.canvas.width/this.width),Math.floor(this.canvas.height/this.height))>>1,b=a<<1;this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);for(var c=0,d=0;d<this.height;d++)for(var e=0;e<this.width;e++){var f=this.pixels[c++],g=e*b+a+PIXEL_MARGIN,h=d*b+a+PIXEL_MARGIN;this.ctx.beginPath();this.ctx.arc(g,h,a-PIXEL_MARGIN,0,2*Math.PI,!1);this.ctx.fillStyle=f.style;this.ctx.fill()}};var ESInput=function(a,b){this.name=a;this.control=b;this.wasReleased=this.wasPressed=this.pressed=!1;this.when=-1};ESInput.prototype.setPressed=function(a,b,c){a?(this.when=c,this.pressed=!0,this.wasPressed&=b,this.wasReleased=!1):this.wasReleased=!0};ESInput.prototype.update=function(){this.wasPressed=this.pressed;this.wasReleased&&(this.pressed=!1)};ESInput.prototype.clicked=function(){return this.pressed&&!this.wasPressed};ESInput.prototype.released=function(){return this.wasReleased&&this.pressed};var KEY_MIDDLE=0,KEY_UP=1,KEY_RIGHT=2,KEY_DOWN=3,KEY_LEFT=4,ESController=function(){this.codeToControl={};this.controls={};this.events=[];this.addControl("middle",KEY_MIDDLE,32);this.addControl("up",KEY_UP,38);this.addControl("right",KEY_RIGHT,39);this.addControl("down",KEY_DOWN,40);this.addControl("left",KEY_LEFT,37)};ESController.prototype.addControl=function(a,b,c){this.controls[b]=new ESInput(a,b);this.codeToControl[c]=b};
ESController.prototype.update=function(){for(var a in this.controls)this.controls[a].update();for(;0<this.events.length;)a=this.events.shift(),this.controls[a.control].setPressed(a.pressed,a.repeat,a.when)};ESController.prototype.handleEvent=function(a,b){a.keyCode in this.codeToControl&&this.events.push({control:this.codeToControl[a.keyCode],pressed:b,repeat:a.repeat,when:Date.now()})};ESController.prototype.getInput=function(a){return this.controls[a]};
...
var DIRECTION_UP=new ESDirection("up",0,2,1,3),DIRECTION_RIGHT=new ESDirection("right",1,3,2,0),DIRECTION_DOWN=new ESDirection("down",2,0,3,1),DIRECTION_LEFT=new ESDirection("left",3,1,0,2),directions=[DIRECTION_UP,DIRECTION_RIGHT,DIRECTION_DOWN,DIRECTION_LEFT];var ENTITY_UNDEFINED=-1,ESEntity=function(a,b,c,d,e){e=void 0===e?ENTITY_UNDEFINED:e;this.world=a;this.pos=new ESVec2(b,c);this.color=d;this.type=e;this.dead=!1};ESEntity.prototype.update=function(){(0>this.pos.x||this.pos.x>=WIDTH)&&this.outOfBounds();(0>this.pos.y||this.pos.y>=HEIGHT)&&this.outOfBounds()};ESEntity.prototype.outOfBounds=function(){this.setDead()};ESEntity.prototype.collides=function(a){return this.pos.equals(a.pos)};ESEntity.prototype.setDead=function(){this.dead=!0};var ESTile=function(){};ESTile.prototype.getColor=function(){return COLOR_BLACK};ESTile.prototype.render=function(a,b,c){var d=this.getColor();null!=d&&a.setPixel(b,c,d)};var ESWorld=function(a){this.app=a;this.reset()};ESWorld.prototype.reset=function(){this.entities=[];this.wonGame=this.gameOver=!1;this.time=0;this.gameOverAnim=TPS};ESWorld.prototype.setGameOver=function(a){this.gameOver=!0;this.wonGame=void 0===a?!1:a};ESWorld.prototype.addEntity=function(a){this.entities.push(a)};ESWorld.prototype.removeEntity=function(a){for(var b=this.entities.length,c=0;c<b;c++)if(this.entities[c]==a){this.entities.splice(c,1);break}};
...
ESTileWorld.prototype.setTile=function(a,b,c){if(0>a||a>=WIDTH||0>b||b>=HEIGHT)return!1;this.tiles[a+b*WIDTH]=c;return!0};ESTileWorld.prototype.renderGame=function(){for(var a=0,b=0;b<HEIGHT;b++)for(var c=0;c<WIDTH;c++)this.tiles[a++].render(this.app,c,b)};var ESMenu=function(a){this.app=a};ESMenu.prototype.enterMenu=function(){};ESMenu.prototype.exitMenu=function(){};ESMenu.prototype.update=function(){};ESMenu.prototype.render=function(){};var ESWorldMenu=function(a,b){ESMenu.call(this,a);this.world=b};$jscomp.inherits(ESWorldMenu,ESMenu);ESWorldMenu.prototype.update=function(){this.world.update()};ESWorldMenu.prototype.render=function(){this.world.render()};var DEBUG=!0,WIDTH=8,HEIGHT=8,PIXEL_MARGIN=2,TPS=20,FPS=60;var ESApp=function(){this.menu=this.controller=this.screen=this.timer=null;this.running=!1};
ESApp.prototype.init=function(){var a=this,b=document.getElementById("screen");if(!b)return logger.fatal("Canvas not found! Make sure it has id: screen"),!1;this.timer=new ESTimer(TPS,DEBUG);this.screen=new ESScreen(b,WIDTH,HEIGHT);this.controller=new ESController;this.menu=null;document.addEventListener("keydown",function(b){return a.controller.handleEvent(b,!0)});document.addEventListener("keyup",function(b){return a.controller.handleEvent(b,!1)});return!0};
ESApp.prototype.setMenu=function(a){null!=this.menu&&(tmpMenu=this.menu,this.menu=null,tmpMenu.exitMenu());this.menu=a;this.menu.enterMenu()};ESApp.prototype.start=function(){logger.info("Launching...");if(!this.init())throw"Unable to launch";logger.info("Launch successful!");this.running=!0;this.timer.init();this.loop()};
ESApp.prototype.loop=function(){var a=this;if(this.running){for(this.timer.clock();0<this.timer.missingTicks;)this.preupdate(),this.update(),this.postupdate(),this.timer.tickPassed();this.prerender();this.render();this.postrender();this.timer.framePassed();this.timer.timeout(function(){return a.loop()},FPS)}};ESApp.prototype.setPixel=function(a,b,c){this.screen.setPixel(a,b,c)};
ESApp.prototype.clear=function(a){a=void 0===a?COLOR_BLACK:a;for(var b=0;b<HEIGHT;b++)for(var c=0;c<WIDTH;c++)this.setPixel(c,b,a)};ESApp.prototype.setTps=function(a){a=void 0===a?DEFAULT_TPS:a;this.timer.setTps(a)};ESApp.prototype.incrementTps=function(a){this.timer.incrementTps(a)};ESApp.prototype.preupdate=function(){this.controller.update();null!=this.menu&&this.menu.update()};ESApp.prototype.update=function(){};ESApp.prototype.postupdate=function(){};
ESApp.prototype.prerender=function(){this.clear();null!=this.menu&&this.menu.render()};ESApp.prototype.render=function(){};ESApp.prototype.postrender=function(){this.screen.drawToScreen()};

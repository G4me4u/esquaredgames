...
$jscomp.polyfill("String.prototype.repeat",function(a){return a?a:function(a){var b=$jscomp.checkStringArgs(this,null,"repeat");if(0>a||1342177279<a)throw new RangeError("Invalid count value");a|=0;for(var d="";a;)if(a&1&&(d+=b),a>>>=1)b+=b;return d}},"es6","es3");var ESApp=function(){this.controller=this.screen=this.timer=null;this.running=!1};
...
ESApp.prototype.setPixel=function(a,b,c){this.screen.setPixel(a,b,c)};ESApp.prototype.clear=function(a){a=void 0===a?COLOR_BLACK:a;for(var b=0;b<HEIGHT;b++)for(var c=0;c<WIDTH;c++)this.setPixel(c,b,a)};ESApp.prototype.setTps=function(a){a=void 0===a?DEFAULT_TPS:a;this.timer.setTps(a)};ESApp.prototype.incrementTps=function(a){this.timer.incrementTps(a)};ESApp.prototype.update=function(){};ESApp.prototype.render=function(){};var DEBUG=!0,WIDTH=8,HEIGHT=8,PIXEL_MARGIN=2,TPS=20,FPS=60;var ESColor=function(a,b,c){this.r=a;this.g=b;this.b=c;this.style="rgb("+this.r+","+this.g+","+this.b+")"};ESColor.prototype.getRed=function(){return this.r};ESColor.prototype.getGreen=function(){return this.g};ESColor.prototype.getBlue=function(){return this.b};ESColor.prototype.getRGB=function(){return this.r<<16|this.g<<8|this.b<<0};
